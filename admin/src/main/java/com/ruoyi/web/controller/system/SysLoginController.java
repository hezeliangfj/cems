...
public class SysLoginController
{
    ...
    public AjaxResult getRouters()
    {
        ...
        List<CmsPermission> permissions = cmsPermissionService.selectPermissionTreeByUserId(userId);
        return AjaxResult.success(cmsPermissionService.buildMenus(permissions));
    }
}
